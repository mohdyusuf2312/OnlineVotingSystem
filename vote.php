...
<body bgcolor="tan">
<center>
<b><font color = "brown" size="6">Online Voting System</font></b><br> <div class="brought"></br></div></center><br><br>
<style>.brought{font-size: 20px; color: white;} </style>
<body>
<div id="page">
<div id="header">
  <h1>CURRENT ELECTIONS</h1>
  <a href="student.php">Home</a> | <a href="vote.php">Current Elections</a> | <a href="manage-profile.php">Manage My Profile</a> | <a href="logout.php">Logout</a>
</div>
<div class="refresh">
</div>
<div id="container">
